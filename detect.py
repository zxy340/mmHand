...
detect_generator = estimator.detect_from_source(image_source, args.num_detections, fig_location_pattern='./results/')
for boxes, scores, nums in detect_generator:
    print('Bounding boxes:', boxes.numpy())
    print('scores:', scores.numpy())
    print('nums:', nums.numpy())
