...
from src.utils.paths import MMWAVE_DATASET_DIR


class mmWaveDataset:

    def __init__(self, dataset_path, batch_size, shuffle=False, left_hand_only=False,
    ...
    def _get_line_annotations(self, annotations):
        annotations = annotations[np.newaxis, 0]
        folder_names = annotations[..., 0]
...
if __name__ == '__main__':
    ds = mmWaveDataset(MMWAVE_DATASET_DIR, batch_size=1, shuffle=False)
